...
@Autonomous
@Config
public class TankREDcycles extends LinearOpMode {

    private static final double WALL_POS = -70.5+(12.5/2.0);
    private static final Pose2d SCORE_0 = new Pose2d(-11, WALL_POS-0.5);
    private static final Pose2d SCORE_1 = new Pose2d(-11+1, WALL_POS-0.5);
    ...
    private static final Pose2d PARK = new Pose2d(41+3, WALL_POS);
    private static final Pose2d WAREHOUSE_0 = new Pose2d(44, WALL_POS);
    private static final Pose2d WAREHOUSE_1 = new Pose2d(50, WALL_POS-0.5);
    private static final Pose2d WAREHOUSE_2 = new Pose2d(54, WALL_POS-0.5);
    private static final Pose2d WAREHOUSE_3 = new Pose2d(58, WALL_POS-1);
    private static final Pose2d WAREHOUSE_4 = new Pose2d(60, WALL_POS-1);
    private static final Pose2d WAREHOUSE_5 = new Pose2d(59, WALL_POS-1);
