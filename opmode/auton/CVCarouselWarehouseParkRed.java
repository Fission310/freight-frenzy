...
@Config
public class CVCarouselWarehouseParkRed extends LinearOpMode {

    public static double SCORE_DISTANCE = 21.5;
    public static double CAROUSEL_STRAFE_DISTANCE = 7;
    public static double CAROUSEL_MOVE_DISTANCE = 43;
    public static double PARK_DISTANCE = 60;
