...
import org.firstinspires.ftc.teamcode.hardware.mechanisms.TankDrivetrain;

public class TankRobot extends Mechanism {
    // init all mechanisms
    private TankDrivetrain dt = new TankDrivetrain(opMode);
    ...
    public TankRobot(LinearOpMode opMode) { this.opMode = opMode; }
